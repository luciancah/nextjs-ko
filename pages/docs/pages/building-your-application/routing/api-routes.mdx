...
<details>
  <summary>Examples</summary>- [Basic API
  Routes](https://github.com/vercel/next.js/tree/canary/examples/api-routes) -
  [API Routes Request
  Helpers](https://github.com/vercel/next.js/tree/canary/examples/api-routes-middleware)
  - [API Routes with
  GraphQL](https://github.com/vercel/next.js/tree/canary/examples/api-routes-graphql)
  - [API Routes with
  REST](https://github.com/vercel/next.js/tree/canary/examples/api-routes-rest)
  - [API Routes with
...
> **Good to know**:- API Routes는 기본적으로 **동일 출처** 만 허용하며, [CORS 헤더를 지정하지 않습니다](https://developer.mozilla.org/docs/Web/HTTP/CORS) . 이러한 동작은 [CORS 요청 도우미](https://github.com/vercel/next.js/tree/canary/examples/api-routes-cors) 로 요청 핸들러를 감싸서 사용자 정의할 수 있습니다.
