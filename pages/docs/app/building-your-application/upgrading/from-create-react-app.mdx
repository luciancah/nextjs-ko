...
Tailwind를 사용하는 경우 `@tailwindcss/postcss`를 설치합니다:

```bash filename="Terminal"
npm install -D tailwindcss @tailwindcss/postcsspages/docs/pages/building-your-application/upgrading/from-create-react-app.mdx
```
